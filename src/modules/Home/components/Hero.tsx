...
const Hero = () => {
  return (
    <main className="lg:overflow-hidden">
      <Section classNames="relative w-full h-screen 2xl:max-h-[800px] py-[120px] lg:pt-[160px] mx-auto">
        <div className="w-full h-full flex flex-col space-y-10 lg:flex-row items-center justify-between">
          ...
          <div className="relative w-full max-w-[500px] mx-auto lg:w-[45%] lg:ml-auto">
            <div className="bg-[#39A0FF] flex items-start w-full h-[400px] lg:w-[450px] lg:h-[450px] rounded-full">
              <div className="absolute top-[65%] left-0 lg:-left-14 flex items-center border border-accent gap-x-1 bg-brandWhite whitespace-nowrap p-2 px-4 rounded-full shadow-xl z-20">
                <MapPin className="text-white fill-yellow-500 w-8 h-8" />
                <p className="text-sm font-semibold">Top Places</p>
              </div>
              <div className="absolute bottom-10 right-0 lg:right-14 flex items-center border border-accent gap-x-1 bg-brandWhite whitespace-nowrap p-2 px-4 rounded-full shadow-xl z-20">
                <Zap className="text-white fill-yellow-500 w-8 h-8" />
                <p className="text-sm font-semibold">Fast Booking</p>
              </div>
              <div className="absolute top-[30%] -right-2 flex items-start border border-accent gap-x-2 bg-brandWhite whitespace-nowrap p-3 px-5 rounded-lg shadow-xl z-20">
